...
import os, sys
print '\x1b[1;32mMasukan ID Dan Pasword: Not Free!!: Chat Wa Aja untuk Login'
print '\x1b[1;32mSilahkan Login '
import os, sys

def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=+62895360130761&text=Assalamualaikum')
...
import getpass
sandi = raw_input('[*]T:')
if sandi == '089674882065' and user == '089674882065':
